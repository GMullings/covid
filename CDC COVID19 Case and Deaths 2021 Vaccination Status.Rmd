...
The below are similar breakdowns of the weekly CFRs from April - December of 2021. Also included are weekly cases per 100,000 for the same time period. For reference 1,000 cases would be equivalent to a 1% weekly case rate.
...
Deaths per 100,000 is a practical way to express the raw mortality rate of a disease. Mortality rates normalize comparisons of death between groups by controlling for the difference between the size of the populations. Because of the low digits typically associated with measuring particular disease mortality in large populations, a figure like 100,000 is used as the base population comparison. For reference, 1000 deaths per 100,000 would be equivalent to a 1% death rate. As practical references according to the CDC in 2020 there were 14.7 deaths per 100,000 Americans from motor vehicle traffic with an annual average rate of 14 between 2015 and 2020, and Influenza and Pneumonia had a rate of 19.8 in 2020 with an average of 20.4 between 2015 and 2020.
...
Differences in Case Fatality Ratios between vaccine products are important to discerning the effectiveness of any given vaccine product. The CFR distribution visually differs between vaccines. Because most of the CFRs are not normally distributed within vaccine types a Wilcox test was conducted to test for statistically significant differences between vaccine types. The results are provided below:
...
A Wilcox test is used due to abnormal CFR distributions. The reults support that J&J's Janssen and Pfizer's vaccines have statistically similar CFRs.
...
There are clear differences over time between CFRs based on vaccination status. Average case fatality ratios in the dataset were nearly twice as high for the unvaccinated who averaged 3.5%. What isn't as clear visually is whether there are differences between every age group, and particularly below 50.

The difference between vaccinated and unvaccinated CFRs is statistically significant. 
...
So is the difference among 12-17 year olds, with the unvaccinated having higher CFRs, below. The average difference between the CFRs of vaccinated and unvaccinated in this age group though is less than 1% of the difference between the total vaccinated and unvaccinated population though.
...
Vaccination protection was especially small for the youngest age group, mostly due to how small the risk is to this age. Similar could be said for age groups under 50: COVID wasn't a non-existent threat but the threat was not so big that vaccination alone could be said to have made a "dangerous" activity "safe." Still, to explain the relatively few deaths that happened among both vaccinated and unvaccinated populations more needs to be understood about the demographics and medical history of the dead.

Age is clearly a determining factor in mortality risk for this and many other viral infections. For those over 50 vaccination in general brought safety to the at-risk. Even after vaccination the elderly were overrepresented among deaths. 

Unfortunately the CDC did not provide vaccine product data segmented by age, future analysis with that data could determine if age interacts with vaccine product types to produce unstable case fatality ratios and mortality rates. There is currently evidence supporting higher rates of myocarditis from the mRNA vaccines in males under 40. With that knowledge sex identification would also illuminate more of the interactions that could exist with vaccination status and vaccine product type affecting case and death outcomes.
...
This analysis was conducted in R. You can find the backup code here: https://github.com/GMullings/covid